...
\;+\; \underbrace{w_c\!\!\sum_{i\in\mathcal{A}}\bigl(\qdot_i - v_i^{\text{post}}\bigr)^2}_{\text{posture field}} \\[4pt]
...
\begin{align}
\hat{e}_{w,X}^{\top} J_{\text{task},X}\,\qdot \;+\; \delta_X \;&\ge\; \hat{e}_{w,X}^{\top}\dot{x}_{\text{ref},X} + \tfrac{\gamma_X}{2}\,\|e_{w,X}\| \label{eq:clf}\\[-1pt]
&\hphantom{{}\ge{}} \text{(CLF, Section~\ref{sec:clf})} \notag \\[2pt]
J_{\text{soft},X}\,\qdot \;&\ge\; -\gamma_{\text{cbf}}\,\bigl(h_{\text{soft},X} - d_{\text{safe},X}\bigr) \label{eq:cbf}\\[-1pt]
&\hphantom{{}\ge{}} \text{(CBF, Section~\ref{sec:cbf})} \notag \\[2pt]
\qdot_{\min,i}^{\text{safe}} \;\le\; \qdot_i \;&\le\; \qdot_{\max,i}^{\text{safe}} \quad \forall i \label{eq:jl}\\[-1pt]
&\hphantom{{}\ge{}} \text{(joint limits, Section~\ref{sec:jl})} \notag
\end{align}
Here:
\begin{itemize}[nosep]
