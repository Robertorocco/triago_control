...
% Running header: faculty logo left, abbreviated thesis title right.
\newcommand{\shorttitle}{Adaptive Shared Autonomy for Bimanual Teleoperation}
\usepackage{fancyhdr}
...
\titlespacing*{\section}{0pt}{2.5ex plus 0.5ex minus 0.3ex}{1.2ex plus 0.2ex}
\titlespacing*{\subsection}{0pt}{2.0ex plus 0.4ex minus 0.2ex}{0.8ex plus 0.2ex}
...
\appendix
\include{chapters/appendix_a_configuration}
