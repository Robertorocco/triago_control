...
# ORIENTATION is raised 0.4 -> 5.0 (25:1 -> 2:1), so the gripper's approach-axis aligns
# tightly at the grasp/release pose. The nominal 25:1 ratio is ideal for free-space
...
TASK_WEIGHTS_6D_GRASP = np.array([1.0, 1.0, 1.0, 0.5, 0.5, 0.5]) * 10.0
