...
class QPVisualizer:
    ...
    def publish_debug(self, model, data, cdata, q, q_dot, target_right, target_left, id_right, id_left, limit_buffer):
        ...
        # --- 2. WORST JOINT LIMIT --- (REMOVED: bandwidth/clutter reduction)
        # The joint-limit avoidance is now handled in the QP cost (Chan-Dubey
        # secondary task) so the debug text overlay is no longer needed.
